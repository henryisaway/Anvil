...
Command command_registry[] = {
    {"help", CMD_HELP, handler_help, "Lists all available commands.", "help [command]", HELP_HELP},
    {"new", CMD_NEW , handler_new, "Creates a new project from a template.", "new <template_name> <project_name>", NEW_HELP},
    {"create", CMD_CREATE, handler_create, "Creates a new template.", "create <template_name> <reference_path>", CREATE_HELP},
    {"delete", CMD_DELETE, handler_delete, "Deletes a template.", "delete <template_name>", DELETE_HELP},
    {"list", CMD_LIST, handler_list, "Lists all available templates.", "list", NULL},
